...
<p align="center">
  <img align="middle" src="figures/setting_summary.png" alt="Intra-processing scenario" width="300"/>
</p>
<center>
  <i>The intra-processing setting: a classification model is trained on centre 1, and debiased on centres 2, 3, and 4 that might have different protected attributes and fairness constraints.</i>
</center>
